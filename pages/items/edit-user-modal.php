    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="mb-3">
            ...
            <input type="password" class="form-control" id="editUserPassword" required readonly>
        </div>
        <div class="mb-3">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-dark" data-bs-dismiss="modal">Fechar</button>
          <button id="editUserBt" type="submit" class="btn btn-success">Editar</button>
